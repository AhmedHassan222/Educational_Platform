    ...
    try {
      await axios
        ...
        .then((res) => {
          setIsloading(false);
          if (res.status === 200) {
            toast.success(" قد تم التعديل بنجاح", {
              position: "top-center",
              autoClose: 3000,
          ...
          if (res.data.message === "Refresh token") {
            toast.error("انتهت صلاحية الجلسة, حاول التسجيل مرة اخري", {
              position: "top-center",
              autoClose: 3000,
              hideProgressBar: false,
              closeOnClick: true,
      ...
      if (error.response.data.Error === "wrong  token") {
        toast.error("انتهت صلاحية , حاول التسجيل مرة اخري", {
          position: "top-center",
          autoClose: 3000,
          hideProgressBar: false,
          closeOnClick: true,
        ...
        <div className=" rounded-4  border-1 widthCustom mx-auto">
          <form encType="multipart/form-data" onSubmit={handleSubmit}>
            <div className=" mb-4 text-end">
              <label className="py-3" htmlFor="image">
                برجاء اختيار صورة جديدة
              </label>
              <input
